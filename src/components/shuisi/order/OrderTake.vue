        ...
        <div class="content">
            <div class="biaoti">
                <el-breadcrumb separator="·">
                    ...
                    <el-breadcrumb-item><span style="color: #30d366;font-weight: bolder">发货单列表</span></el-breadcrumb-item>
                </el-breadcrumb>
            </div>
            <ul class="shuaixuan">
                <li>
                    <el-select v-model="value" placeholder="请选择订单状态" style="width: 160px">
                        <el-option
                ...
                <li>
                    <el-input v-model="input1" placeholder="请输入发货单流水号" style="width: 180px"></el-input>
                </li>
                <li>
            ...
            <div class="item">
                <el-table
                    ...
                    <el-table-column prop="data1" label="下单时间" show-overflow-tooltip>
                    </el-table-column>
                    <el-table-column prop="data2" label="发货时间" show-overflow-tooltip>
                    </el-table-column>
                    <el-table-column prop="data3" label="退款时间" show-overflow-tooltip>
                    </el-table-column>
                    ...
                    <el-table-column prop="operation" label="操作" width="100" show-overflow-tooltip>
                        <template slot-scope="scope">
                            <router-link to="/OrderTakeDetails">
