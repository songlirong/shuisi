        ...
        <div class="content">
            <div class="biaoti">
                <el-breadcrumb separator="·">
                    ...
                    <el-breadcrumb-item><span style="color: #30d366;font-weight: bolder">维修服务订单</span></el-breadcrumb-item>
                </el-breadcrumb>
            </div>
            <ul class="shuaixuan">
                <li>
                ...
                <el-tabs v-model="activeName" @tab-click="handleClick">
                    <el-tab-pane label="全部订单（2）" name="first">
                        <el-table
                            ...
                            <el-table-column prop="name" label="维修服务名称" width="120" show-overflow-tooltip>
                            </el-table-column>
                            <el-table-column prop="money" label="订金" show-overflow-tooltip>
                            </el-table-column>
                            <el-table-column prop="money1" label="维修服务费" width="90" show-overflow-tooltip>
                            </el-table-column>
                            <el-table-column label="收货人" show-overflow-tooltip>
                            ...
                            <el-table-column prop="zhuangtai" label="订单状态" show-overflow-tooltip>
                            </el-table-column>
                            <el-table-column prop="data" label="下单时间" show-overflow-tooltip>
                            </el-table-column>
                            <el-table-column prop="data1" label="服务时间" show-overflow-tooltip>
                            </el-table-column>
                            <el-table-column prop="operation" label="操作" show-overflow-tooltip>
                                <template slot-scope="scope">
                                    <router-link to="/OrderServiceDetails">
                    ...
                    <el-tab-pane label="待维修（1）" name="third">待维修（1）</el-tab-pane>
