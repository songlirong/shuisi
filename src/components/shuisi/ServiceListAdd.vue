        ...
        <div class="aside">
            ...
            <ul class="aside-list">
                <li>
                    ...
                    <router-link to="/service">维修服务列表</router-link>
                </li>
                <li>
                    <div class="col-box"></div>
                    <router-link to="/service/ServiceEvaluate">服务评价</router-link>
                </li>
            </ul>
        </div>
        <!--主内容-->
            ...
            <div style="width: 1064px;margin:0 auto;">
                <div class="biaoti">
                    <el-breadcrumb separator="·">
                        ...
                        <el-breadcrumb-item><span style="color: #30d366;font-weight: bolder">添加维修服务</span></el-breadcrumb-item>
                    </el-breadcrumb>
                </div>
                <div class="item">
                    <div class="bottom">
                    ...
                    <div style="padding-left:15%">
                        <el-button type="primary" round class="green">发布维修</el-button>
