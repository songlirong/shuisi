            ...
            <div style="width: 1064px;margin: auto">
                ...
                <div class="item">
                    <el-steps :active="4" align-center style="margin-bottom: 20px">
                        ...
                        <el-step title="商家发货" description="2018-03-20 12:00:02"></el-step>
                        <el-step title="确认收货" description="2018-03-20 12:00:02"></el-step>
                    ...
                    <div class="bottom">
                        ...
                        <div class="title">
                            <el-table :data="tableData" style="width: 100%;font-size: 14px">
                                ...
                                <el-table-column prop="name" label="购货人" width="120"></el-table-column>
                                ...
                                <el-table-column prop="type1" label="配送方式"></el-table-column>
                                <el-table-column prop="data3" label="发货时间"></el-table-column>
                                <el-table-column prop="data4" label="自动确认收货时间"></el-table-column>
                            </el-table>
                        </div>
                    </div>
                    <div class="bottom">
                    ...
                    <div class="bottom">
                        ...
                        <div class="title">
                            <el-table :data="tableData4" style="width: 100%;">
                                ...
                                <el-table-column prop="money2" label="配送费用 "></el-table-column>
                                <el-table-column prop="money3" label="折扣"></el-table-column>
                                <el-table-column prop="jinbi" label="使用金币"></el-table-column>
                                <el-table-column prop="coupon" label="使用优惠券"></el-table-column>
                                <el-table-column prop="money4" label="订单总金额"></el-table-column>
                                <el-table-column prop="money5" label="应付总金额"></el-table-column>
                            </el-table>
                        </div>
                    </div>
                    <div class="bottom">
